...
class PromptBarState extends State<PromptBar> with TickerProviderStateMixin {
  ...
  void _stopVoiceIfListening() {
    // Only manage dictation when this PromptBar owns a speech control. In the
    // Bengali voice-first page `speechEnabled` is false here because the
    // continuous command listener is managed globally and must stay enabled.
    if (widget.speechEnabled && widget.listening) {
          ...
          children: [
              ...
              child: Focus(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'বাংলায় বা ইংরেজিতে প্রশ্ন লিখুন…',
                    hintStyle: TextStyle(
            ...
            if (widget.speechEnabled)
              _buildModernButton(
                label: widget.listening
                    ...
                    : 'ভয়েস ইনপুট চালু করুন',
                hint: widget.listening
                    ? 'ভয়েস রেকর্ডিং বন্ধ করতে দুইবার ট্যাপ করুন'
                    : 'ভয়েস রেকর্ডিং চালু করতে দুইবার ট্যাপ করুন',
            ...
            Row(
              children: [
                ...
                _buildModernButton(
                  label: 'শুধু লেখা পাঠান',
                  hint: hasText
                      ? 'শুধু লেখা হিসেবে পাঠাতে দুইবার ট্যাপ করুন'
                      : 'আগে একটি প্রশ্ন লিখুন',
                ...
                _buildModernButton(
                  label: 'ছবিসহ পাঠান',
                  hint: hasText
                      ? 'ক্যামেরার ছবিসহ পাঠাতে দুইবার ট্যাপ করুন'
                      : 'আগে একটি প্রশ্ন লিখুন',
